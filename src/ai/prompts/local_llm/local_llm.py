...
TASK_TOOL_DESCRIPTION = (
    ...
    "example, 'in two minutes', 'later', 'tonight', or 'tomorrow' - calculate "
    "run_at from the authoritative Runtime clock in this system prompt. Never "
    "copy a date from an example or from a past message. If the user already "
    "asked for the task, proceed directly with tasks.add; do not ask for "
    "confirmation.\n"
